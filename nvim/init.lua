...
vim.api.nvim_create_autocmd("FileType", {
	pattern = "java",
	callback = function()
		vim.opt_local.expandtab = false -- Använd riktiga tabs, inte spaces
		vim.opt_local.tabstop = 4 -- 1 tab == 4 spaces på skärmen
		vim.opt_local.shiftwidth = 4 -- Indentering med 4 spaces motsvarande
		vim.opt_local.softtabstop = 4 -- När du trycker tabb, flytta 4 spaces
	end,
})
--[[
			...
			require("lualine").setup({
				...
				sections = {
					...
					lualine_b = {
						...
						{
							"diff",
							colored = true, -- Enables color for diff
							diff_color = {
								added = { fg = "#094f06" }, -- Darker Green (bright #34eb49)
								modified = { fg = "#eba534" }, -- Darker Yellow
								removed = { fg = "#e01010" }, -- Darker Red
							},
						},
					},
